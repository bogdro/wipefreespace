...
# define ntfs_list_head list_head
# define ntfs_list_for_each_safe(pos, n, head) list_for_each_safe(pos, n, head)
# define ntfs_list_entry(ptr, type, member) list_entry(ptr, type, member)
# define NTFS_INIT_LIST_HEAD(ptr) INIT_LIST_HEAD(ptr)
